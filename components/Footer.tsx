...
export default function Footer() {
  ...
  const footerLinks = {
    'Marketplace': [
      { name: 'Browse Art', href: '/marketplace', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg> },
